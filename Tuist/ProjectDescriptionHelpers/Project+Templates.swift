...
extension Project {
    ...
    public static func app(
        name: String,
        platform: Platform,
        frameworksTargets: [String],
        dependenciesTargets: [TargetDependency] = []
    ) -> Project {
        var targets = makeAppTargets(name: name,
                                     platform: platform,
                                     dependencies: frameworksTargets.map { TargetDependency.target(name: $0) } + dependenciesTargets)
